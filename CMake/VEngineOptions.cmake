...
set(VE_IOS_PACKAGE_DATA_MANIFEST "" CACHE FILEPATH "Optional iOS package data manifest copied into the iOS app bundle")
...
function(ve_validate_ios_options)
    ...
    if(VE_IOS_PACKAGE_DATA_MANIFEST AND NOT EXISTS "${VE_IOS_PACKAGE_DATA_MANIFEST}")
        message(FATAL_ERROR "VE_IOS_PACKAGE_DATA_MANIFEST does not exist: ${VE_IOS_PACKAGE_DATA_MANIFEST}")
    endif()
