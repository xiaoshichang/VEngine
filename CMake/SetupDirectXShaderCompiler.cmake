...
function(ve_download_dxc_package outVariable)
    ...
    if(NOT EXISTS "${dxcExecutable}")
        execute_process(
            COMMAND "${VE_DXC_THIRD_PARTY_ROOT}/Setup_Windows64.bat"
...
function(ve_setup_directx_shader_compiler)
    ...
    if(NOT VE_DXC_EXECUTABLE AND VE_DXC_DOWNLOAD_IF_MISSING)
        ...
        if(downloadedDxcExecutable)
            set(VE_DXC_EXECUTABLE "${downloadedDxcExecutable}" CACHE FILEPATH "Path to the dxc executable used for D3D12 DXIL output." FORCE)
        endif()
    endif()
