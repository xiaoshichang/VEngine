...
namespace ve
{
    ...
    ///
    /// Push() allocates one node per value. This keeps the primitive general and simple for first-stage runtime
    /// systems. Higher-level queues may add pooling later without changing their public queue semantics.
    template<typename T>
    ...
    public:
        ...
        ///
        /// This function is safe to call from multiple producer threads. Returns OutOfMemory when node allocation
        /// fails.
        ...
        ///
        /// This function must be called only by the single consumer thread. Returns std::nullopt when no fully linked
        /// node is available.
        ...
        ///
        /// This query is intended for the single consumer and shutdown diagnostics. The result can become stale
        /// immediately while producers continue running.
