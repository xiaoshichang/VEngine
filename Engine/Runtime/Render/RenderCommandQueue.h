...
namespace ve
{
    ...
    ///
    /// Multiple engine systems may submit render commands concurrently. The Render Thread is the only consumer. This
    /// class intentionally owns render-command naming and payload semantics, while LockFreeMpscQueue owns the
    /// lower-level MPSC publication algorithm.
