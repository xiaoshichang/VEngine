...
namespace ve
{
    ...
    ///
    /// `Vector3` is intentionally a compact value type. Store it directly inside runtime objects; use `PoolAllocator`
    /// for the owning objects when many transform-like records need fixed-size allocation.
    class Vector3
    {
    public:
