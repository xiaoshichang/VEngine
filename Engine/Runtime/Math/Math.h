...
///
/// The caller is expected to pass `minimum <= maximum`; this helper mirrors `std::clamp` while keeping engine naming.
...
///
/// Use this for tests and editor-facing comparisons; avoid it for gameplay thresholds that need explicit domain rules.
