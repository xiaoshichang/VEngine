...
///
/// Components are owned by exactly one GameObject. Scene update traverses the GameObject tree and calls OnUpdate() for
/// enabled GameObjects and enabled Components.
