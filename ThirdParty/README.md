...
Generated source checkouts, archives, build directories, and binaries are ignored by git. Vendored source libraries such
as Dear ImGui are tracked in this directory with their CMake wrappers and short dependency notes.
