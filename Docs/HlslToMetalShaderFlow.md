...
1. Compile `DemoProject/Assets/Engine/Shaders/BasicMesh.hlsl` to D3D11 DXBC.
2. Compile `DemoProject/Assets/Engine/Shaders/BasicMesh.hlsl` to D3D12 DXIL.
3. Compile `DemoProject/Assets/Engine/Shaders/BasicMesh.hlsl` to SPIR-V.
