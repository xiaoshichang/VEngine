#include "Editor/Windows/WinEditorInputBackend.h"
...
namespace ve::editor
{
    ...
    WinEditorInputBackend::~WinEditorInputBackend()
    {
        Shutdown();
    }

    ErrorCode WinEditorInputBackend::Init(void* nativeWindowHandle)
    {
        if (initialized_)
        {
    ...
    void WinEditorInputBackend::StartFrame()
    {
    ...
    void WinEditorInputBackend::BeginOSEventFrame() noexcept
    {
        mouseDeltaX_ = 0;
        mouseDeltaY_ = 0;
    }

    bool WinEditorInputBackend::OnOSEvent(const OSEvent& event)
    {
        VE_ASSERT_SCENE_THREAD();
        if (!initialized_)
        {
    ...
    void WinEditorInputBackend::StoreMousePosition(const OSEvent& event) noexcept
    {
    ...
    void WinEditorInputBackend::Shutdown() noexcept
    {
        if (!initialized_)
        {
            return;
    ...
    bool WinEditorInputBackend::IsInitialized() const noexcept
    {
        return initialized_;
    }

    Int32 WinEditorInputBackend::GetMouseDeltaX() const noexcept
    {
        return mouseDeltaX_;
    }

    Int32 WinEditorInputBackend::GetMouseDeltaY() const noexcept
    {
        return mouseDeltaY_;
    }

    std::unique_ptr<EditorInputBackend> CreateWinEditorInputBackend()
    {
        return std::make_unique<WinEditorInputBackend>();
    }
} // namespace ve::editor
