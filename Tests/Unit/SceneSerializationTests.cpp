...
namespace
{
    ...
    bool TestSceneRoundTrip()
    {
        ...
        mesh->SetMeshAssetID(ve::AssetID(ve::Guid::Parse("11111111-1111-1111-1111-111111111111").GetValue()));
        mesh->SetMaterialAssetID(ve::AssetID(ve::Guid::Parse("22222222-2222-2222-2222-222222222222").GetValue()));
        ...
        ve::Result<ve::CameraComponent*> cameraResult = cameraObject->AddComponentWithoutRenderRegistration<ve::CameraComponent>();
        ...
        ve::Result<ve::LightComponent*> lightResult = lightObject->AddComponentWithoutRenderRegistration<ve::LightComponent>();
        ...
        passed &= Expect(serialized.GetValue().find("\n    \"rootGameObjects\"") != std::string::npos, "Scene JSON should be pretty-printed");
        ...
        passed &= Expect(loadedRootTransform->GetLocalPosition().IsNearlyEqual(ve::Vector3(1.0f, 2.0f, 3.0f)), "Root position should round-trip");
        ...
        passed &= Expect(loadedMesh->GetMeshAssetID().ToString() == "11111111-1111-1111-1111-111111111111:0", "Mesh AssetID should round-trip");

        ve::GameObject* loadedCameraObject = loadedRootTransform->GetChildGameObject(0);
        passed &= Expect(loadedCameraObject != nullptr && loadedCameraObject->GetName() == "Camera", "Child object should round-trip");
