...
namespace
{
    ...
    bool TestInitialization()
    {
        ...
        passed &=
            Expect(initializeResult == ve::ErrorCode::None, "InitializeLogging should succeed with a quiet config");
        ...
        passed &= Expect(duplicateInitializeResult == ve::ErrorCode::InvalidState,
    ...
    bool TestFileOutputAndFormatting()
    {
        ...
        passed &= Expect(logText.find("Missing Texture") != std::string::npos,
                         "Formatted category message should be written");
        ...
        passed &=
            Expect(infoLine.find("LoggingTests.cpp") == std::string::npos, "Info logs should omit source location");
        passed &=
            Expect(warnLine.find("LoggingTests.cpp") == std::string::npos, "Warn logs should omit source location");
        passed &=
            Expect(errorLine.find("LoggingTests.cpp") != std::string::npos, "Error logs should include source file");
